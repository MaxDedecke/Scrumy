...
- Design-Standard, kein Vorschlag: Jedes Frontend nutzt Tailwind CSS und shadcn/ui-Komponenten statt eigener Ad-hoc-Styles – ein Projekt soll von der ersten Ansicht an wie ein vorzeigbares Produkt aussehen, nicht wie ein Rohentwurf. Dazu gehört: eine im Code festgelegte Farb- und Typografie-Skala statt verstreuter Hex-Werte oder Font-Größen, Tailwinds Spacing-Skala statt beliebiger Pixelwerte, ein durchdachter Zustand für leer/lädt/Fehler bei jeder Ansicht mit Daten (nicht nur der Erfolgsfall), und ein Layout, das auf Mobile- wie auf Desktop-Breite funktioniert. Weiche davon nur ab, wenn Konzept, Anforderungen oder ein Beschluss des Auftraggebers ausdrücklich ein anderes UI-Kit verlangen, oder bestehender, importierter Code schon eines mitbringt.
